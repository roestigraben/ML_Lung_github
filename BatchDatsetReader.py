...
class BatchDatset:
    ...
    def _transform(self, filename):
        ...
        # print('filename : ', filename, 'image shape : ', image.shape)
    ...
    def next_batch(self, batch_size):
        print('batch ' + str(self.batch_offset) + ' of ' + str(batch_size) + ' images of total of ' + str(self.images.shape[0]))
